...
## 파일 다운로드
* [MuteOzWL1.2.zip (v1.2)](https://github.com/progh2/MuteOZWL/releases/download/v1.2/MuteOzWL1.2.zip)

## 사용법
1. [MuteOzWL1.2.zip](https://github.com/progh2/MuteOZWL/releases/download/v1.2/MuteOzWL1.2.zip) 파일을 다운받아 압축을 풀어주세요(압축 해제 프로그램으로는 [반디집](https://kr.bandisoft.com/bandizip/)을 추천합니다.).
